import { gameAssets, sendEvent } from './game.js';
...
export class Monster {
  ...
  init(level) {
    ...
    this.attackPower = monsterAssets.data[this.monsterNumber].attackPower + 1 * level; // 몬스터의 공격력 (기지에 가해지는 데미지)
    this.goldReward = monsterAssets.data[this.monsterNumber].goldReward + 2 * level;
  }
